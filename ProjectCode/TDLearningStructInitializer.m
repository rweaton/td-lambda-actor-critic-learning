function OutputStruct = TDLearningStructInitializer(...
...
%    
%     Initializes all variables required for TDLearning and Environment
%     routines.
%     
%     Written by Ryan Eaton, 5/20/2009
%     Revised: 5/24/2009, 5/27/2009
%     Debugged: 5/24/2009
    ...
    OutputStruct.PrevEnvStruct.FatigueSpecs = FatigueSpecs; 
    OutputStruct.PrevEnvStruct.ReinforcingStimAccumulationParams = ...
        ReinforcingStimAccumulationParams;
